export default {
  ...
  login: {
    ...
    notice: `YesPlayMusic promises not to save any of your account information to the cloud.<br />
      ...
      YesPlayMusic is not the official website of NetEase Music, please consider carefully before entering account information. You can also go to <a href="https://spark.tsmoe.com">YesPlayMusic's GitHub repository</a> to build and use the self-hosted NetEase Music API.`,
