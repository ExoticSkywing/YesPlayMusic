export default {
  ...
  login: {
    ...
    notice: `YesPlayMusic hesabınızın hiçbir bilgisini kaydetmeyeceğine dair söz veriyor<br />
      ...
      YesPlayMusic, NetEase Music'in resmi websitesi değildir, lütfen hesap bilgilerinizi girmeden önce dikkatlice düşününüz. Aynı zamanda, Kendi NetEase Musix API'nızı host etmek için <a href="https://spark.tsmoe.com">YesPlayMusic'in GitHub Repo'suna</a> gidebilirsiniz.`,
